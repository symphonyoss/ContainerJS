...
As a result, PRs submitted to the ssf-desktop-wrapper project cannot be accepted until you have a CLA in place with the Foundation.
 ...
 * For documentation contributions, follow the general structure, language, and tone of the [existing docs](https://github.com/ScottLogic/ssf-desktop-wrapper/wiki).
 ...
 * If necessary (e.g. due to 3rd party dependency licensing requirements), update the [NOTICE file](https://github.com/ScottLogic/ssf-desktop-wrapper/blob/master/NOTICE) with any new attribution or other notices
