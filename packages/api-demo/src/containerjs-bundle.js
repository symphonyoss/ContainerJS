...
var MessageService = (function () {
    ...
    MessageService.send = function (windowId, topic, message) {
        var _a = windowId.split(':'), appId = _a[0], windowName = _a[1];
        if (appId && windowName) {
    ...
    MessageService.subscribe = function (windowId, topic, listener) {
        var _a = windowId.split(':'), appId = _a[0], windowName = _a[1];
        if (appId && windowName) {
    ...
    MessageService.unsubscribe = function (windowId, topic, listener) {
        var _a = windowId.split(':'), appId = _a[0], windowName = _a[1];
        if (appId && windowName) {
...
var ScreenSnippet = (function () {
    function ScreenSnippet() {
    }
    ScreenSnippet.prototype.capture = function () {
        return new Promise(function (resolve, reject) {
            fin.desktop.Window.getCurrent()
                .getSnapshot(function (snapshot) { resolve('data:image/png;base64,' + snapshot); }, reject);
        });
    };
...
var convertOptions = function (options) {
    var frameSize = navigator.appVersion.indexOf('Win') != -1 ? 20 : 25;
    ...
    Object.keys(optionsMap).forEach(function (optionKey) {
        var openFinOptionKey = optionsMap[optionKey];
...
var Window = (function () {
    function Window(options, callback, errorCallback) {
        var _this = this;
        this.children = [];
        this.eventListeners = new Map();
        MessageService.subscribe('*', 'ssf-window-message', function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i] = arguments[_i];
            }
            var event = 'message';
            if (_this.eventListeners.has(event)) {
                _this.eventListeners.get(event).forEach(function (listener) { return listener.apply(void 0, args); });
            }
        });
        if (!options) {
        ...
        var openFinOptions = convertOptions(options);
        if (openFinOptions.child) {
            var currentWindow_1 = Window.getCurrentWindow();
            currentWindow_1.children.push(this);
            this.innerWindow = new fin.desktop.Window(openFinOptions, function () {
            ...
            var appOptions = {
                ...
                uuid: openFinOptions.name,
                mainWindowOptions: openFinOptions
            };
            var app_1 = new fin.desktop.Application(appOptions, function (successObject) {
                app_1.run();
                _this.innerWindow = app_1.getWindow();
                if (callback) {
                    callback(_this);
                }
            }, errorCallback);
    ...
    Window.prototype.asPromise = function (fn) {
        var _this = this;
        var args = [];
        ...
        return new Promise(function (resolve, reject) {
            if (_this.innerWindow) {
                var openFinFunction = _this.innerWindow[fn];
                openFinFunction.call.apply(openFinFunction, [_this.innerWindow].concat(args, [resolve, reject]));
            }
            else {
    ...
    Window.prototype.close = function () {
        ...
        return this.asPromise('close', false)
            .then(function () {
            _this.innerWindow = undefined;
        });
    };
    Window.prototype.flashFrame = function (flag) {
        if (flag) {
    ...
    Window.prototype.getChildWindows = function () {
        return this.children;
    };
    Window.prototype.getId = function () {
        return this.innerWindow.uuid + ":" + this.innerWindow.name;
    };
    Window.prototype.getMaximumSize = function () {
        return this.getOptions()
            .then(function (options) { return [options.maxWidth, options.maxHeight]; });
    };
    Window.prototype.getMinimumSize = function () {
        return this.getOptions()
            .then(function (options) { return [options.minWidth, options.minHeight]; });
    };
    Window.prototype.getOptions = function () {
    ...
    Window.prototype.getParentWindow = function () {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.innerWindow) {
                var parent_1 = null;
                if (window.opener) {
                    var win = fin.desktop.Window.wrap(_this.innerWindow.uuid, window.opener.name);
                    parent_1 = new Window(null, null, null);
                    parent_1.innerWindow = win;
                }
                resolve(parent_1);
            }
            else {
    ...
    Window.prototype.getPosition = function () {
        return this.getBounds()
            .then(function (bounds) { return [bounds.x, bounds.y]; });
    };
    Window.prototype.getSize = function () {
        return this.getBounds()
            .then(function (bounds) { return [bounds.width, bounds.height]; });
    };
    Window.prototype.getTitle = function () {
        return this.getOptions()
            .then(function (options) { return options.title; });
    };
    Window.prototype.getState = function () {
        return this.asPromise('getState');
    };
    Window.prototype.hasShadow = function () {
        return this.getOptions()
            .then(function (options) { return options.shadow; });
    };
    ...
    Window.prototype.isAlwaysOnTop = function () {
        return this.getOptions()
            .then(function (options) { return options.alwaysOnTop; });
    };
    Window.prototype.isMaximizable = function () {
        return this.getOptions()
            .then(function (options) { return options.maximizable; });
    };
    Window.prototype.isMaximized = function () {
        return this.getState()
            .then(function (state) { return state === windowStates.MAXIMIZED; });
    };
    Window.prototype.isMinimizable = function () {
        return this.getOptions()
            .then(function (options) { return options.minimizable; });
    };
    Window.prototype.isMinimized = function () {
        return this.getState()
            .then(function (state) { return state === windowStates.MINIMIZED; });
    };
    Window.prototype.isResizable = function () {
        return this.getOptions()
            .then(function (options) { return options.resizable; });
    };
    Window.prototype.isVisible = function () {
        return this.asPromise('isShowing');
    };
    ...
    Window.prototype.setIcon = function (icon) {
        return this.updateOptions({ icon: icon });
    };
    Window.prototype.setMaximizable = function (maximizable) {
        return this.updateOptions({ maximizable: maximizable });
    };
    Window.prototype.setMaximumSize = function (maxWidth, maxHeight) {
        return this.updateOptions({ maxWidth: maxWidth, maxHeight: maxHeight });
    };
    Window.prototype.setMinimizable = function (minimizable) {
        return this.updateOptions({ minimizable: minimizable });
    };
    Window.prototype.setMinimumSize = function (minWidth, minHeight) {
        return this.updateOptions({ minWidth: minWidth, minHeight: minHeight });
    };
    ...
    Window.prototype.updateOptions = function (options) {
        return this.asPromise('updateOptions', options);
    };
    Window.prototype.addListener = function (event, listener) {
        if (this.eventListeners.has(event)) {
            var temp = this.eventListeners.get(event);
            temp.push(listener);
    ...
    Window.prototype.removeListener = function (event, listener) {
        if (this.eventListeners.has(event)) {
    ...
    Window.prototype.removeAllListeners = function () {
        var _this = this;
        this.eventListeners.forEach(function (value, key) {
            value.forEach(function (listener) {
                _this.innerWindow.removeEventListener(key, listener);
            });
        });
        this.eventListeners.clear();
    };
    Window.prototype.postMessage = function (message) {
        MessageService.send(this.innerWindow.uuid + ":" + this.innerWindow.name, 'ssf-window-message', message);
    };
    Window.getCurrentWindow = function (callback, errorCallback) {
        if (currentWindow) {
...
var getAccessibleWindow = function (name) { return accessibleWindows[name]; };
var addAccessibleWindow = function (name, win) {
    accessibleWindows[name] = win;
};
var removeAccessibleWindow = function (name) {
    delete accessibleWindows[name];
};

var currentWindow$1 = null;
var windowClosedError = new Error('The window does not exist or the window has been closed');
var withInnerWindow = function (win, fn) {
    return new Promise(function (resolve, reject) {
        if (win) {
            fn(win);
            resolve();
...
var Window$2 = (function () {
    function Window(options, callback, errorCallback) {
        ...
        if (!options) {
            ...
            this.innerWindow.onclose = function () {
                removeAccessibleWindow(_this.innerWindow.name);
            };
            var currentWindow_1 = Window.getCurrentWindow();
            currentWindow_1.children.push(this);
        ...
        this.addListener('message', function (e) {
            var event = 'message';
            if (_this.eventListeners.has(event)) {
                _this.eventListeners.get(event).forEach(function (listener) { return listener(e.data); });
            }
        });
        if (callback) {
            callback();
    ...
    Window.prototype.close = function () {
        ...
        return withInnerWindow(this.innerWindow, function (innerWindow) { return innerWindow.close(); });
    };
    Window.prototype.show = function () {
    ...
    Window.prototype.focus = function () {
        return withInnerWindow(this.innerWindow, function (innerWindow) { return innerWindow.focus(); });
    };
    Window.prototype.blur = function () {
        return withInnerWindow(this.innerWindow, function (innerWindow) { return innerWindow.blur(); });
    };
    Window.prototype.addListener = function (event, listener) {
        if (this.eventListeners.has(event)) {
            var temp = this.eventListeners.get(event);
        ...
        this.innerWindow.addEventListener(eventMap$1[event], listener);
    };
    Window.prototype.removeListener = function (event, listener) {
        if (this.eventListeners.has(event)) {
            var listeners = this.eventListeners.get(event);
        ...
        this.innerWindow.removeEventListener(eventMap$1[event], listener);
    };
    Window.prototype.removeAllListeners = function () {
        var _this = this;
        this.eventListeners.forEach(function (value, key) {
            value.forEach(function (listener) {
                _this.innerWindow.removeEventListener(eventMap$1[key], listener);
            });
        });
        this.eventListeners.clear();
    };
    ...
    Window.getCurrentWindow = function (callback, errorCallback) {
        ...
        currentWindow$1 = new Window(null, callback, errorCallback);
        return currentWindow$1;
    };
    return Window;
}());
var objectToFeaturesString = function (features) {
...
var MessageService$2 = (function () {
    function MessageService() {
    }
    MessageService.send = function (windowId, topic, message) {
        var win = getAccessibleWindow(windowId);
        var senderId = Window$2.getCurrentWindow().getId();
        if (win) {
            win.postMessage({
                senderId: senderId,
                topic: topic,
    ...
    MessageService.unsubscribe = function (windowId, topic, listener) {
        ...
        // i.e. {} !== {}
        listenerMap.forEach(function (value, key) {
...
var ScreenSnippet$2 = (function () {
    function ScreenSnippet() {
    }
    ScreenSnippet.prototype.capture = function () {
        return html2canvas(document.body)
            .then(function (canvas) { return canvas.toDataURL(); });
    };
    return ScreenSnippet;
}());
...
var index$3 = Object.freeze({
	app: app$2,
	MessageService: MessageService$2,
	ScreenSnippet: ScreenSnippet$2,
	Window: Window$2
});

var require$$0 = ( index$2 && undefined ) || index$2;
